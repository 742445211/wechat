...
<article class="cl pd-20">
	<form action="/dorolefp" method="get" class="form form-horizontal" id="form-admin-role-add">
					...
					<dd>
						...
						<tr class="cl permission-list2">
							<dd>
								<label class="">
									<input type="checkbox" 
									@foreach($usernode as $row)
									  @if($row->nid==$list->id)
									  checked
									  @endif
									@endforeach
									value="{{$list->id}}" name="role[]" id="user-Character-0-0-0">
									{{$list->nodename}}</label>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<label class="">
									{{$list->kname}}</label>
