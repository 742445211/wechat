    ...
    <form class="form form-horizontal" id="form-article-add" enctype =“multipart/form-data”>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="@if(isset($data)){{$data['name']}}@endif" placeholder="输入该图片所属的标题" id="name" name="name">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                ...
                @else
                    <input type="hidden" name="adminid" id="adminid" value="insert" data-id="{{$id}}">
                @endif
...
<script>
    ...
    function addimg(token) {
        ...
        $.ajax({
            ...
            data:{
                name:name,intro:intro,img:imgpath,type:type,id:id
            },
