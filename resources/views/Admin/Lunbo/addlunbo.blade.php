	...
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="输入排序的优先级" id="level" name="level">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				...
				<button onClick="layer_close();" id="btns" class="btn btn-default radius" type="button">&nbsp;&nbsp;取消&nbsp;&nbsp;</button>
			</div>
		</div>
	</form>
</div>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/index/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript">
    function article_save()   //提交
    {
        ...
        $.get('/upimgres',{level:level,adminid:adminid},function(data){
            if(data == '1'){
    ...
    function layer_close()   //取消
    {
        $('#btns').attr('disabled','true');
        var index = parent.layer.getFrameIndex(window.name); //获取窗口索引
        var adminid = $('#adminid').val();
        $.get('/upimgres',{adminid:adminid,status:1},function(data){
                parent.layer.msg('已取消操作!');  //提示
                parent.layer.close(index);   //关闭当前页面
        })
    }
$(function(){
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: '/index/lib/webuploader/0.1.5/Uploader.swf',
	
		// 文件接收服务端。
		server: '/index/lib/webuploader/0.1.5/server/fileupload.php',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('/index/lib/webuploader/0.1.5/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
